...
/// Example:
/// ```dart
/// NorthAmericaBajoNuevoBankPetrelIs10mWidget(
...
/// )
/// ```
class NorthAmericaBajoNuevoBankPetrelIs10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaBajoNuevoBankPetrelIs10mWidget.
  const NorthAmericaBajoNuevoBankPetrelIs10mWidget({
    super.key,
