...
/// )
/// ```
class DominicanRepublic110mWidget extends StatelessWidget {
  ...
  /// Creates a DominicanRepublic110mWidget.
  const DominicanRepublic110mWidget({
    super.key,
