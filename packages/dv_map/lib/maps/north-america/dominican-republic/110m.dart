...
/// Widget for rendering the north-america/dominican-republic.110m.json map.
///
...
/// Example:
/// ```dart
/// NorthAmericaDominicanRepublic110mWidget(
...
/// )
/// ```
class NorthAmericaDominicanRepublic110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaDominicanRepublic110mWidget.
  const NorthAmericaDominicanRepublic110mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: northAmericaDominicanRepublic110m,
