...
/// Example:
/// ```dart
/// NorthAmericaMontserrat10mWidget(
...
/// )
/// ```
class NorthAmericaMontserrat10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaMontserrat10mWidget.
  const NorthAmericaMontserrat10mWidget({
    super.key,
