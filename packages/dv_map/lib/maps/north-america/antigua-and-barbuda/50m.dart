...
/// Example:
/// ```dart
/// NorthAmericaAntiguaAndBarbuda50mWidget(
...
/// )
/// ```
class NorthAmericaAntiguaAndBarbuda50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaAntiguaAndBarbuda50mWidget.
  const NorthAmericaAntiguaAndBarbuda50mWidget({
    super.key,
