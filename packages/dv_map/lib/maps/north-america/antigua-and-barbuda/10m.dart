...
/// Example:
/// ```dart
/// NorthAmericaAntiguaAndBarbuda10mWidget(
...
/// )
/// ```
class NorthAmericaAntiguaAndBarbuda10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaAntiguaAndBarbuda10mWidget.
  const NorthAmericaAntiguaAndBarbuda10mWidget({
    super.key,
