...
/// Example:
/// ```dart
/// NorthAmericaSaintLucia10mWidget(
...
/// )
/// ```
class NorthAmericaSaintLucia10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaSaintLucia10mWidget.
  const NorthAmericaSaintLucia10mWidget({
    super.key,
