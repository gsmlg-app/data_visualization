...
/// Example:
/// ```dart
/// NorthAmericaSaintLucia50mWidget(
...
/// )
/// ```
class NorthAmericaSaintLucia50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaSaintLucia50mWidget.
  const NorthAmericaSaintLucia50mWidget({
    super.key,
