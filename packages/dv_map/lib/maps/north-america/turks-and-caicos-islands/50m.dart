...
/// Example:
/// ```dart
/// TurksAndCaicosIslands50mWidget(
...
/// )
/// ```
class TurksAndCaicosIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a TurksAndCaicosIslands50mWidget.
  const TurksAndCaicosIslands50mWidget({
    super.key,
