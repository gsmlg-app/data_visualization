...
/// )
/// ```
class NorthAmericaBelize110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaBelize110mWidget.
  const NorthAmericaBelize110mWidget({
    super.key,
