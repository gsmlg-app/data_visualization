...
/// Widget for rendering the north-america/cuba.110m.json map.
///
...
/// )
/// ```
class NorthAmericaCuba110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaCuba110mWidget.
  const NorthAmericaCuba110mWidget({
    super.key,
