...
/// )
/// ```
class NorthAmericaAnguilla10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaAnguilla10mWidget.
  const NorthAmericaAnguilla10mWidget({
    super.key,
