...
/// Example:
/// ```dart
/// NorthAmericaCaymanIslands50mWidget(
...
/// )
/// ```
class NorthAmericaCaymanIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaCaymanIslands50mWidget.
  const NorthAmericaCaymanIslands50mWidget({
    super.key,
