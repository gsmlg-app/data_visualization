...
/// Widget for rendering the north-america/jamaica.110m.json map.
///
...
/// )
/// ```
class NorthAmericaJamaica110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaJamaica110mWidget.
  const NorthAmericaJamaica110mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: northAmericaJamaica110m,
