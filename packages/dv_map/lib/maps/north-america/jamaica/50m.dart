...
/// )
/// ```
class NorthAmericaJamaica50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaJamaica50mWidget.
  const NorthAmericaJamaica50mWidget({
    super.key,
