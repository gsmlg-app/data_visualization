...
/// Example:
/// ```dart
/// UnitedStatesVirginIslands50mWidget(
...
/// )
/// ```
class UnitedStatesVirginIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a UnitedStatesVirginIslands50mWidget.
  const UnitedStatesVirginIslands50mWidget({
    super.key,
