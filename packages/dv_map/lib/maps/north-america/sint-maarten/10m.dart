...
/// Example:
/// ```dart
/// NorthAmericaSintMaarten10mWidget(
...
/// )
/// ```
class NorthAmericaSintMaarten10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaSintMaarten10mWidget.
  const NorthAmericaSintMaarten10mWidget({
    super.key,
