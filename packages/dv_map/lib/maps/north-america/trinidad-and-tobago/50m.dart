...
/// )
/// ```
class TrinidadAndTobago50mWidget extends StatelessWidget {
  ...
  /// Creates a TrinidadAndTobago50mWidget.
  const TrinidadAndTobago50mWidget({
    super.key,
