...
/// Widget for rendering the north-america/trinidad-and-tobago.110m.json map.
///
...
/// Example:
/// ```dart
/// NorthAmericaTrinidadAndTobago110mWidget(
...
/// )
/// ```
class NorthAmericaTrinidadAndTobago110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaTrinidadAndTobago110mWidget.
  const NorthAmericaTrinidadAndTobago110mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: northAmericaTrinidadAndTobago110m,
