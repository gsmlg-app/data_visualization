...
/// Example:
/// ```dart
/// NorthAmericaHonduras110mWidget(
...
/// )
/// ```
class NorthAmericaHonduras110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaHonduras110mWidget.
  const NorthAmericaHonduras110mWidget({
    super.key,
