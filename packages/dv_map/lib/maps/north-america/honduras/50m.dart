...
/// )
/// ```
class NorthAmericaHonduras50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaHonduras50mWidget.
  const NorthAmericaHonduras50mWidget({
    super.key,
