...
/// Example:
/// ```dart
/// NorthAmericaPuertoRico110mWidget(
...
/// )
/// ```
class NorthAmericaPuertoRico110mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaPuertoRico110mWidget.
  const NorthAmericaPuertoRico110mWidget({
    super.key,
