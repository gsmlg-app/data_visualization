...
/// Example:
/// ```dart
/// NorthAmericaBritishVirginIslands10mWidget(
...
/// )
/// ```
class NorthAmericaBritishVirginIslands10mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaBritishVirginIslands10mWidget.
  const NorthAmericaBritishVirginIslands10mWidget({
    super.key,
