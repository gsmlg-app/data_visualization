...
/// Widget for rendering the north-america/curacao.50m.json map.
///
...
/// )
/// ```
class NorthAmericaCuracao50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaCuracao50mWidget.
  const NorthAmericaCuracao50mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: northAmericaCuracao50m,
