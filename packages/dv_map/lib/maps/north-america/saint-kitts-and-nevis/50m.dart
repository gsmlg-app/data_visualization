...
/// Example:
/// ```dart
/// NorthAmericaSaintKittsAndNevis50mWidget(
...
/// )
/// ```
class NorthAmericaSaintKittsAndNevis50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaSaintKittsAndNevis50mWidget.
  const NorthAmericaSaintKittsAndNevis50mWidget({
    super.key,
