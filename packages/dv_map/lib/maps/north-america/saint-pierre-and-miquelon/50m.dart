...
/// Widget for rendering the north-america/saint-pierre-and-miquelon.50m.json map.
///
...
/// Example:
/// ```dart
/// NorthAmericaSaintPierreAndMiquelon50mWidget(
...
/// )
/// ```
class NorthAmericaSaintPierreAndMiquelon50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthAmericaSaintPierreAndMiquelon50mWidget.
  const NorthAmericaSaintPierreAndMiquelon50mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: northAmericaSaintPierreAndMiquelon50m,
