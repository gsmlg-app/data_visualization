...
/// Example:
/// ```dart
/// SaintPierreAndMiquelon50mWidget(
...
/// )
/// ```
class SaintPierreAndMiquelon50mWidget extends StatelessWidget {
  ...
  /// Creates a SaintPierreAndMiquelon50mWidget.
  const SaintPierreAndMiquelon50mWidget({
    super.key,
