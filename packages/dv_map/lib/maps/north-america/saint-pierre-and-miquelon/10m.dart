...
/// Example:
/// ```dart
/// SaintPierreAndMiquelon10mWidget(
...
/// )
/// ```
class SaintPierreAndMiquelon10mWidget extends StatelessWidget {
  ...
  /// Creates a SaintPierreAndMiquelon10mWidget.
  const SaintPierreAndMiquelon10mWidget({
    super.key,
