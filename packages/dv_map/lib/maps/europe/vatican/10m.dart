...
/// Widget for rendering the europe/vatican.10m.json map.
///
...
/// )
/// ```
class EuropeVatican10mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeVatican10mWidget.
  const EuropeVatican10mWidget({
    super.key,
