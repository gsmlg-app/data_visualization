...
/// )
/// ```
class EuropeMontenegro110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeMontenegro110mWidget.
  const EuropeMontenegro110mWidget({
    super.key,
