...
/// Widget for rendering the europe/moldova.110m.json map.
///
...
/// )
/// ```
class EuropeMoldova110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeMoldova110mWidget.
  const EuropeMoldova110mWidget({
    super.key,
