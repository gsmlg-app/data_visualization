...
/// Widget for rendering the europe/guernsey.50m.json map.
///
...
/// )
/// ```
class EuropeGuernsey50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeGuernsey50mWidget.
  const EuropeGuernsey50mWidget({
    super.key,
