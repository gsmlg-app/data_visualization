...
/// Widget for rendering the europe/lithuania.110m.json map.
///
...
/// )
/// ```
class EuropeLithuania110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeLithuania110mWidget.
  const EuropeLithuania110mWidget({
    super.key,
