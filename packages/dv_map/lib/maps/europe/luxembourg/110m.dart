...
/// )
/// ```
class EuropeLuxembourg110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeLuxembourg110mWidget.
  const EuropeLuxembourg110mWidget({
    super.key,
