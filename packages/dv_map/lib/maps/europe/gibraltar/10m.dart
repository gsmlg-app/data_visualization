...
/// Widget for rendering the europe/gibraltar.10m.json map.
///
...
/// )
/// ```
class EuropeGibraltar10mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeGibraltar10mWidget.
  const EuropeGibraltar10mWidget({
    super.key,
