...
/// )
/// ```
class EuropeSwitzerland50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeSwitzerland50mWidget.
  const EuropeSwitzerland50mWidget({
    super.key,
