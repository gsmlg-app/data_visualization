...
/// Widget for rendering the europe/iceland.110m.json map.
///
...
/// )
/// ```
class EuropeIceland110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeIceland110mWidget.
  const EuropeIceland110mWidget({
    super.key,
