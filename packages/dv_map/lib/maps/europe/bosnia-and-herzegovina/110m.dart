...
/// Example:
/// ```dart
/// BosniaAndHerzegovina110mWidget(
...
/// )
/// ```
class BosniaAndHerzegovina110mWidget extends StatelessWidget {
  ...
  /// Creates a BosniaAndHerzegovina110mWidget.
  const BosniaAndHerzegovina110mWidget({
    super.key,
