...
/// Widget for rendering the europe/monaco.50m.json map.
///
...
/// )
/// ```
class EuropeMonaco50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeMonaco50mWidget.
  const EuropeMonaco50mWidget({
    super.key,
