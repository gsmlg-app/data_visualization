...
/// Widget for rendering the europe/sweden.110m.json map.
///
...
/// )
/// ```
class EuropeSweden110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeSweden110mWidget.
  const EuropeSweden110mWidget({
    super.key,
