...
/// )
/// ```
class EuropeFaroeIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeFaroeIslands50mWidget.
  const EuropeFaroeIslands50mWidget({
    super.key,
