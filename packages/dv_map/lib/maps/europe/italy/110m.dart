...
/// Widget for rendering the europe/italy.110m.json map.
///
...
/// )
/// ```
class EuropeItaly110mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeItaly110mWidget.
  const EuropeItaly110mWidget({
    super.key,
