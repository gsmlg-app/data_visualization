...
/// Widget for rendering the europe/san-marino.10m.json map.
///
...
/// )
/// ```
class EuropeSanMarino10mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeSanMarino10mWidget.
  const EuropeSanMarino10mWidget({
    super.key,
