...
/// Widget for rendering the europe/isle-of-man.50m.json map.
///
...
/// )
/// ```
class EuropeIsleOfMan50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeIsleOfMan50mWidget.
  const EuropeIsleOfMan50mWidget({
    super.key,
