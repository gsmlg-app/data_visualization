...
/// Widget for rendering the europe/slovakia.50m.json map.
///
...
/// )
/// ```
class EuropeSlovakia50mWidget extends StatelessWidget {
  ...
  /// Creates a EuropeSlovakia50mWidget.
  const EuropeSlovakia50mWidget({
    super.key,
