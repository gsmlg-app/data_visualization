...
/// Example:
/// ```dart
/// OceaniaNorthernMarianaIslands10mWidget(
...
/// )
/// ```
class OceaniaNorthernMarianaIslands10mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaNorthernMarianaIslands10mWidget.
  const OceaniaNorthernMarianaIslands10mWidget({
    super.key,
