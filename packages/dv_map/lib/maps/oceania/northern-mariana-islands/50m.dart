...
/// Example:
/// ```dart
/// NorthernMarianaIslands50mWidget(
...
/// )
/// ```
class NorthernMarianaIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a NorthernMarianaIslands50mWidget.
  const NorthernMarianaIslands50mWidget({
    super.key,
