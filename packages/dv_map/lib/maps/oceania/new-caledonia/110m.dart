...
/// )
/// ```
class OceaniaNewCaledonia110mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaNewCaledonia110mWidget.
  const OceaniaNewCaledonia110mWidget({
    super.key,
