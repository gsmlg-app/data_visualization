...
/// )
/// ```
class OceaniaCookIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaCookIslands50mWidget.
  const OceaniaCookIslands50mWidget({
    super.key,
