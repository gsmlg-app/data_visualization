...
/// )
/// ```
class OceaniaCookIslands10mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaCookIslands10mWidget.
  const OceaniaCookIslands10mWidget({
    super.key,
