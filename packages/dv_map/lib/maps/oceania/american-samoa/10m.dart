...
/// )
/// ```
class OceaniaAmericanSamoa10mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaAmericanSamoa10mWidget.
  const OceaniaAmericanSamoa10mWidget({
    super.key,
