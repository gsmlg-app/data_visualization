...
/// )
/// ```
class OceaniaAmericanSamoa50mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaAmericanSamoa50mWidget.
  const OceaniaAmericanSamoa50mWidget({
    super.key,
