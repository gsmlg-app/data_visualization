...
/// Widget for rendering the oceania/norfolk-island.50m.json map.
///
...
/// )
/// ```
class OceaniaNorfolkIsland50mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaNorfolkIsland50mWidget.
  const OceaniaNorfolkIsland50mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: oceaniaNorfolkIsland50m,
