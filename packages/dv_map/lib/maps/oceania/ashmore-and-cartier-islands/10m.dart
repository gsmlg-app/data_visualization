...
/// Example:
/// ```dart
/// OceaniaAshmoreAndCartierIslands10mWidget(
...
/// )
/// ```
class OceaniaAshmoreAndCartierIslands10mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaAshmoreAndCartierIslands10mWidget.
  const OceaniaAshmoreAndCartierIslands10mWidget({
    super.key,
