...
/// Example:
/// ```dart
/// OceaniaAshmoreAndCartierIslands50mWidget(
...
/// )
/// ```
class OceaniaAshmoreAndCartierIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaAshmoreAndCartierIslands50mWidget.
  const OceaniaAshmoreAndCartierIslands50mWidget({
    super.key,
