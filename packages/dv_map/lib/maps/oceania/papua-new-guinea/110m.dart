...
/// Example:
/// ```dart
/// OceaniaPapuaNewGuinea110mWidget(
...
/// )
/// ```
class OceaniaPapuaNewGuinea110mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaPapuaNewGuinea110mWidget.
  const OceaniaPapuaNewGuinea110mWidget({
    super.key,
