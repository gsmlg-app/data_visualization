...
/// Widget for rendering the oceania/samoa.50m.json map.
///
...
/// )
/// ```
class OceaniaSamoa50mWidget extends StatelessWidget {
  ...
  /// Creates a OceaniaSamoa50mWidget.
  const OceaniaSamoa50mWidget({
    super.key,
