...
/// )
/// ```
class SouthAmericaBolivia50mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaBolivia50mWidget.
  const SouthAmericaBolivia50mWidget({
    super.key,
