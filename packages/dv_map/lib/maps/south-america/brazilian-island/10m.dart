...
/// Example:
/// ```dart
/// SouthAmericaBrazilianIsland10mWidget(
...
/// )
/// ```
class SouthAmericaBrazilianIsland10mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaBrazilianIsland10mWidget.
  const SouthAmericaBrazilianIsland10mWidget({
    super.key,
