...
/// )
/// ```
class SouthAmericaUruguay110mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaUruguay110mWidget.
  const SouthAmericaUruguay110mWidget({
    super.key,
