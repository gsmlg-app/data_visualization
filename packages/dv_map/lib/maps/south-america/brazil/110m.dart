...
/// )
/// ```
class SouthAmericaBrazil110mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaBrazil110mWidget.
  const SouthAmericaBrazil110mWidget({
    super.key,
