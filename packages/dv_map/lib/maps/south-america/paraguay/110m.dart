...
/// Example:
/// ```dart
/// SouthAmericaParaguay110mWidget(
...
/// )
/// ```
class SouthAmericaParaguay110mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaParaguay110mWidget.
  const SouthAmericaParaguay110mWidget({
    super.key,
