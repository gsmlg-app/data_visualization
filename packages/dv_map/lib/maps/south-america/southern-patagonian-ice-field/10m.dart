...
/// Example:
/// ```dart
/// SouthAmericaSouthernPatagonianIceField10mWidget(
...
/// )
/// ```
class SouthAmericaSouthernPatagonianIceField10mWidget extends StatelessWidget {
  ...
  /// Creates a SouthAmericaSouthernPatagonianIceField10mWidget.
  const SouthAmericaSouthernPatagonianIceField10mWidget({
    super.key,
