...
/// Example:
/// ```dart
/// BritishIndianOceanTerritory10mWidget(
...
/// )
/// ```
class BritishIndianOceanTerritory10mWidget extends StatelessWidget {
  ...
  /// Creates a BritishIndianOceanTerritory10mWidget.
  const BritishIndianOceanTerritory10mWidget({
    super.key,
