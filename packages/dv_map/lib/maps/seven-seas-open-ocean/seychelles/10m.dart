...
/// Example:
/// ```dart
/// SevenSeasOpenOceanSeychelles10mWidget(
...
/// )
/// ```
class SevenSeasOpenOceanSeychelles10mWidget extends StatelessWidget {
  ...
  /// Creates a SevenSeasOpenOceanSeychelles10mWidget.
  const SevenSeasOpenOceanSeychelles10mWidget({
    super.key,
