...
/// Example:
/// ```dart
/// SevenSeasOpenOceanSeychelles50mWidget(
...
/// )
/// ```
class SevenSeasOpenOceanSeychelles50mWidget extends StatelessWidget {
  ...
  /// Creates a SevenSeasOpenOceanSeychelles50mWidget.
  const SevenSeasOpenOceanSeychelles50mWidget({
    super.key,
