...
/// Example:
/// ```dart
/// SevenSeasOpenOceanSaintHelena50mWidget(
...
/// )
/// ```
class SevenSeasOpenOceanSaintHelena50mWidget extends StatelessWidget {
  ...
  /// Creates a SevenSeasOpenOceanSaintHelena50mWidget.
  const SevenSeasOpenOceanSaintHelena50mWidget({
    super.key,
