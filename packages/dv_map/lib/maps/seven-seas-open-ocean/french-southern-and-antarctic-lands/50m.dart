...
/// Example:
/// ```dart
/// SevenSeasOpenOceanFrenchSouthernAndAntarcticLands50mWidget(
...
/// )
/// ```
class SevenSeasOpenOceanFrenchSouthernAndAntarcticLands50mWidget extends StatelessWidget {
  ...
  /// Creates a SevenSeasOpenOceanFrenchSouthernAndAntarcticLands50mWidget.
  const SevenSeasOpenOceanFrenchSouthernAndAntarcticLands50mWidget({
    super.key,
