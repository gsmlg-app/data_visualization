...
/// Example:
/// ```dart
/// HeardIslandAndMcdonaldIslands50mWidget(
...
/// )
/// ```
class HeardIslandAndMcdonaldIslands50mWidget extends StatelessWidget {
  ...
  /// Creates a HeardIslandAndMcdonaldIslands50mWidget.
  const HeardIslandAndMcdonaldIslands50mWidget({
    super.key,
