...
/// Widget for rendering the africa/gambia.110m.json map.
///
...
/// )
/// ```
class AfricaGambia110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaGambia110mWidget.
  const AfricaGambia110mWidget({
    super.key,
