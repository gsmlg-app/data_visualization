...
/// Widget for rendering the africa/comoros.50m.json map.
///
...
/// )
/// ```
class AfricaComoros50mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaComoros50mWidget.
  const AfricaComoros50mWidget({
    super.key,
