...
/// Widget for rendering the africa/mozambique.110m.json map.
///
...
/// )
/// ```
class AfricaMozambique110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaMozambique110mWidget.
  const AfricaMozambique110mWidget({
    super.key,
