...
/// Example:
/// ```dart
/// AfricaUnitedRepublicOfTanzania50mWidget(
...
/// )
/// ```
class AfricaUnitedRepublicOfTanzania50mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaUnitedRepublicOfTanzania50mWidget.
  const AfricaUnitedRepublicOfTanzania50mWidget({
    super.key,
