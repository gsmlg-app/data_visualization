...
/// Widget for rendering the africa/eswatini.110m.json map.
///
...
/// )
/// ```
class AfricaEswatini110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaEswatini110mWidget.
  const AfricaEswatini110mWidget({
    super.key,
