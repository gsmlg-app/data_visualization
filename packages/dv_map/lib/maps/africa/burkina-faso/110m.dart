...
/// Widget for rendering the africa/burkina-faso.110m.json map.
///
...
/// )
/// ```
class AfricaBurkinaFaso110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaBurkinaFaso110mWidget.
  const AfricaBurkinaFaso110mWidget({
    super.key,
