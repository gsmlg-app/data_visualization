...
/// )
/// ```
class AfricaGuineaBissau110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaGuineaBissau110mWidget.
  const AfricaGuineaBissau110mWidget({
    super.key,
