...
/// Widget for rendering the africa/guinea-bissau.50m.json map.
///
...
/// )
/// ```
class AfricaGuineaBissau50mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaGuineaBissau50mWidget.
  const AfricaGuineaBissau50mWidget({
    super.key,
