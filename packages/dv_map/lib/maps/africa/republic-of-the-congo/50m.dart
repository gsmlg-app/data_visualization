...
/// )
/// ```
class RepublicOfTheCongo50mWidget extends StatelessWidget {
  ...
  /// Creates a RepublicOfTheCongo50mWidget.
  const RepublicOfTheCongo50mWidget({
    super.key,
