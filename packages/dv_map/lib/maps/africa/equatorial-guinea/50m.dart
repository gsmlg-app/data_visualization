...
/// Widget for rendering the africa/equatorial-guinea.50m.json map.
///
...
/// Example:
/// ```dart
/// AfricaEquatorialGuinea50mWidget(
...
/// )
/// ```
class AfricaEquatorialGuinea50mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaEquatorialGuinea50mWidget.
  const AfricaEquatorialGuinea50mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: africaEquatorialGuinea50m,
