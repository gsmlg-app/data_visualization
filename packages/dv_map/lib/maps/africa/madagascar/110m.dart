...
/// Widget for rendering the africa/madagascar.110m.json map.
///
...
/// )
/// ```
class AfricaMadagascar110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaMadagascar110mWidget.
  const AfricaMadagascar110mWidget({
    super.key,
