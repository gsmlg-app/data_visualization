...
/// Widget for rendering the africa/lesotho.110m.json map.
///
...
/// )
/// ```
class AfricaLesotho110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaLesotho110mWidget.
  const AfricaLesotho110mWidget({
    super.key,
