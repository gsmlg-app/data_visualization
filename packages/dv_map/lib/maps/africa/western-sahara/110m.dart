...
/// )
/// ```
class AfricaWesternSahara110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaWesternSahara110mWidget.
  const AfricaWesternSahara110mWidget({
    super.key,
