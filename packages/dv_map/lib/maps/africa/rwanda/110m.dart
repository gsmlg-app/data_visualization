...
/// Widget for rendering the africa/rwanda.110m.json map.
///
...
/// )
/// ```
class AfricaRwanda110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaRwanda110mWidget.
  const AfricaRwanda110mWidget({
    super.key,
