...
/// Widget for rendering the africa/mali.110m.json map.
///
...
/// )
/// ```
class AfricaMali110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaMali110mWidget.
  const AfricaMali110mWidget({
    super.key,
