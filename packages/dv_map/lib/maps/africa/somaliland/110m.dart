...
/// )
/// ```
class AfricaSomaliland110mWidget extends StatelessWidget {
  ...
  /// Creates a AfricaSomaliland110mWidget.
  const AfricaSomaliland110mWidget({
    super.key,
