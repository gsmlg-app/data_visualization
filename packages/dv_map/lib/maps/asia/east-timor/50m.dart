...
/// Widget for rendering the asia/east-timor.50m.json map.
///
...
/// )
/// ```
class AsiaEastTimor50mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaEastTimor50mWidget.
  const AsiaEastTimor50mWidget({
    super.key,
