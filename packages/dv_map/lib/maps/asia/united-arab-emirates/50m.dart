...
/// )
/// ```
class UnitedArabEmirates50mWidget extends StatelessWidget {
  ...
  /// Creates a UnitedArabEmirates50mWidget.
  const UnitedArabEmirates50mWidget({
    super.key,
