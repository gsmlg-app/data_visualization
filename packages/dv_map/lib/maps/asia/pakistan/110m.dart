...
/// Widget for rendering the asia/pakistan.110m.json map.
///
...
/// )
/// ```
class AsiaPakistan110mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaPakistan110mWidget.
  const AsiaPakistan110mWidget({
    super.key,
