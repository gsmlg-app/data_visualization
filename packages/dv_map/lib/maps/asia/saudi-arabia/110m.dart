...
/// Widget for rendering the asia/saudi-arabia.110m.json map.
///
...
/// )
/// ```
class AsiaSaudiArabia110mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaSaudiArabia110mWidget.
  const AsiaSaudiArabia110mWidget({
    super.key,
