...
/// Widget for rendering the asia/afghanistan.110m.json map.
///
...
/// )
/// ```
class AsiaAfghanistan110mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaAfghanistan110mWidget.
  const AsiaAfghanistan110mWidget({
    super.key,
