...
/// Widget for rendering the asia/spratly-islands.10m.json map.
///
...
/// )
/// ```
class AsiaSpratlyIslands10mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaSpratlyIslands10mWidget.
  const AsiaSpratlyIslands10mWidget({
    super.key,
