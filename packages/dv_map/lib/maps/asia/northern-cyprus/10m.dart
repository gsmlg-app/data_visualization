...
/// )
/// ```
class AsiaNorthernCyprus10mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaNorthernCyprus10mWidget.
  const AsiaNorthernCyprus10mWidget({
    super.key,
