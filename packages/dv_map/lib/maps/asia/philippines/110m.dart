...
/// Widget for rendering the asia/philippines.110m.json map.
///
...
/// )
/// ```
class AsiaPhilippines110mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaPhilippines110mWidget.
  const AsiaPhilippines110mWidget({
    super.key,
