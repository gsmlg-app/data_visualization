...
/// Widget for rendering the asia/macao-s-a-r.50m.json map.
///
...
/// )
/// ```
class AsiaMacaoSAR50mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaMacaoSAR50mWidget.
  const AsiaMacaoSAR50mWidget({
    super.key,
