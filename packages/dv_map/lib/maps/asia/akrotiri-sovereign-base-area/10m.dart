...
/// Example:
/// ```dart
/// AkrotiriSovereignBaseArea10mWidget(
...
/// )
/// ```
class AkrotiriSovereignBaseArea10mWidget extends StatelessWidget {
  ...
  /// Creates a AkrotiriSovereignBaseArea10mWidget.
  const AkrotiriSovereignBaseArea10mWidget({
    super.key,
