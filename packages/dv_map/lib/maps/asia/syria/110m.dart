...
/// Widget for rendering the asia/syria.110m.json map.
///
...
/// )
/// ```
class AsiaSyria110mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaSyria110mWidget.
  const AsiaSyria110mWidget({
    super.key,
