...
/// Widget for rendering the asia/baykonur-cosmodrome.10m.json map.
///
...
/// Example:
/// ```dart
/// AsiaBaykonurCosmodrome10mWidget(
...
/// )
/// ```
class AsiaBaykonurCosmodrome10mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaBaykonurCosmodrome10mWidget.
  const AsiaBaykonurCosmodrome10mWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return MapWidget(
      geoJson: asiaBaykonurCosmodrome10m,
