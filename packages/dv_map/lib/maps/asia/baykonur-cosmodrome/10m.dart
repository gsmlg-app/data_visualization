...
/// )
/// ```
class BaykonurCosmodrome10mWidget extends StatelessWidget {
  ...
  /// Creates a BaykonurCosmodrome10mWidget.
  const BaykonurCosmodrome10mWidget({
    super.key,
