...
/// Example:
/// ```dart
/// IndianOceanTerritories50mWidget(
...
/// )
/// ```
class IndianOceanTerritories50mWidget extends StatelessWidget {
  ...
  /// Creates a IndianOceanTerritories50mWidget.
  const IndianOceanTerritories50mWidget({
    super.key,
