...
/// Example:
/// ```dart
/// AsiaIndianOceanTerritories10mWidget(
...
/// )
/// ```
class AsiaIndianOceanTerritories10mWidget extends StatelessWidget {
  ...
  /// Creates a AsiaIndianOceanTerritories10mWidget.
  const AsiaIndianOceanTerritories10mWidget({
    super.key,
